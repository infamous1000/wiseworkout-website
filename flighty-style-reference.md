...
### sans-serif — sans-serif · `--font-sans-serif`
- **Weights:** 400
- **Sizes:** 12px
- **Line height:** 1.2
- **Role:** sans-serif
...
### SF Pro Text Regular — SF Pro Text Regular · `--font-sf-pro-text-regular`
- **Weights:** 400
- **Sizes:** 13px, 15px
- **Line height:** 1.2, 1.5
- **Role:** SF Pro Text Regular

### SF Pro Text Semibold — SF Pro Text Semibold · `--font-sf-pro-text-semibold`
- **Weights:** 400
- **Sizes:** 13px
- **Line height:** 1.2
- **Role:** SF Pro Text Semibold
...
### Indie Flower — Indie Flower · `--font-indie-flower`
- **Weights:** 400
- **Sizes:** 16px
- **Line height:** 1.2
- **Role:** Indie Flower
...
Signal Blue
#007bff
Primary action button fill, active link states, focus indicators — the single chromatic action color in an otherwise achromatic system

Copy
Deep Indigo
#0d0021
Dark section backgrounds, announcement bar, hero gradient base — the midnight-violet that makes screens glow
Accent
...
Amber Alert
#f7be00
Download CTA, high-priority callouts, notification accents — warm yellow against dark surfaces for the conversion moment
...
Pure Black
#000000
Primary text, icon strokes, hairline borders, ghost button fills — the structural ink of the system

Copy
Midnight Ink
#05010d
Dark card surfaces, deepest background layer — near-black with a violet undertone

Copy
Carbon
#333333
Secondary text, subdued body copy — reads softer than pure black for paragraph-length content

Copy
Slate
#595959
Tertiary text, metadata, timestamps in notification cards

Copy
Steel
#737373
Muted body text, disabled states, inactive nav items

Copy
Fog
#808080
Placeholder text, dimmed labels, low-priority metadata

Copy
Ash
#89898e
Cool gray for pressed states and slightly cooler text — the only neutral with a slight blue cast

Copy
Silver
#cfcfcf
Hairline borders, card outlines, subtle dividers, very light surface tint

Copy
Linen
#faf8f7
Warm off-white surface — alternate card background, subtle tonal shift from pure white

Copy
Pure White
#ffffff
Light canvas, notification card surfaces, text on dark — the dominant surface color in the upper page
Typography
Type Scale
...
13–56px · 7 values
Line height
1.00–2.00 (display headlines 1.00, body 1.38, loose body 1.50–2.00)
Letter spacing
-0.025–-0.005px · 5 values
Fallback
